			...
			<div class="col-12 col-lg-12 p-0 m-1 main-box row">
				<div class="col-12 px-0 row">
					<div class="col-8 px-3 py-3">
						<span class="fas fa-info-circle"></span> {{ __('Edit').' '.__('User') }} 
					</div>
					...
					<div class="col-12 col-lg-12 p-2">
						...
						<div class="col-12 pt-3">
							<select class="form-control" name="blocked">
								<option @if($user->blocked=="0") selected @endif value="0">{{ __('No')}}</option>
								<option @if($user->blocked=="1") selected @endif value="1">{{ __('Yes')}}</option>
							</select>
						</div>
					</div>
