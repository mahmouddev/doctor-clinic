    ...
    <div class="col-12 p-3">
        ...
        <div class="col-12 col-lg-12 p-0 ">
            <form id="validate-form" class="needs-validation" novalidate enctype="multipart/form-data" method="POST"
                action="{{ route('admin.clinic.prescriptions.update', $prescription) }}">
                @csrf
                @method('PUT')
                ...
                <x-bread-crumb :breads="[
                    ...
                    <div class=" col-lg-12 p-0 m-1 main-box row">
                     <div class="row p-3">
                        <div class="col-lg-9">
                            <span class="fas fa-info-circle"></span> {{ __('Edit') . ' ' . __('Prescription') }}
                        </div>
                                ...
                                <div class="col-lg-12 p-2">
                                    ...
                                    <div class="pt-1 position-relative">
                                        ...
                                        <input type="text" name="name" required minlength="3" maxlength="190"
                                            class="form-control px-4 @error('name') is-invalid @enderror" value="{{ old('name',  $prescription->name) }}">
                            ...
                            <div class="row pt-2 mt-2">
                                <div class=" col-lg-4 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <input type="email" name="email" class="form-control px-4 @error('email') is-invalid @enderror"
                                            value="{{ old('email',  $prescription->email ) }}">
                                        <span class="invalid-feedback position-absolute">
                                ...
                                <div class=" col-lg-4 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <input type="phone" value="{{ old('phone' ,  $prescription->phone)}}" name="phone" required class="form-control px-4 @error('phone') is-invalid @enderror" >
                                        <span class="invalid-feedback position-absolute">
                                ...
                                <div class=" col-lg-4 p-2">
                                    ...
                                    <div class="pt-1 position-relative">
                                        <input type="date" value="{{ old('dob' , $prescription->dob->format('Y-m-d'))}}" name="dob" required class="form-control @error('dob') is-invalid @enderror" >
                                        <span class="invalid-feedback position-absolute">
                                ...
                                <div class=" col-lg-4 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4 @error('gendar') is-invalid @enderror" required name="gendar">
                                            ...
                                            <option @if (old('gendar' , $prescription->gendar) == 'male') selected @endif value="male">
                                                {{ __('Male') }}</option>
                                            <option @if (old('gendar' , $prescription->gendar) == 'female') selected @endif value="female">
                                                {{ __('Female') }}</option>
                                        </select>
                                        <span class="invalid-feedback position-absolute">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4" name="blood_group">
                                            ...
                                            @foreach ($blood_groups as $blood_group)
                                                <option @if (old('blood_group' , $prescription->blood_group) == $blood_group) selected @endif
                                ...
                                <div class=" col-lg-4 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4" name="diabetic">
                                            <option value="">{{__('Plese select.....')}}</option>
                                            <option class="pt-1" @if (old('diabetic', $prescription->diabetic) == '0') selected @endif
                                                value="0">{{ __('No') }}</option>
                                            <option class="pt-1" @if (old('diabetic', $prescription->diabetic) == '1') selected @endif
                                ...
                                <div class=" col-lg-12 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4" name="hbp">
                                            <option value="">{{__('Plese select.....')}}</option>
                                            <option @if (old('hbp', $prescription->hbp) == '0') selected @endif value="0">
                                                {{ __('No') }}</option>
                                            <option @if (old('hbp', $prescription->hbp) == '1') selected @endif value="1">
                                                {{ __('Yes') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class=" col-lg-12 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4" name="heart_diseases">
                                            <option value="">{{__('Plese select.....')}}</option>
                                            <option @if (old('heart_diseases', $prescription->heart_diseases) == '0') selected @endif value="0">
                                                {{ __('No') }}</option>
                                            <option @if (old('heart_diseases', $prescription->heart_diseases) == '1') selected @endif value="1">
                                                {{ __('Yes') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class=" col-lg-12 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4" name="accidents">
                                            <option value="">{{__('Plese select.....')}}</option>
                                            <option @if (old('accidents', $prescription->accidents) == '0') selected @endif value="0">
                                                {{ __('No') }}</option>
                                            <option @if (old('accidents', $prescription->accidents) == '1') selected @endif value="1">
                                                {{ __('Yes') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class=" col-lg-12 p-2">
                                    ...
                                    <div class=" pt-1 position-relative">
                                        ...
                                        <select class="form-control px-4" name="surgeries">
                                            <option value="">{{__('Plese select.....')}}</option>
                                            <option @if (old('surgeries', $prescription->surgeries) == '0') selected @endif value="0">
                                                {{ __('No') }}</option>
                                            <option @if (old('surgeries', $prescription->surgeries) == '1') selected @endif value="1">
                                                {{ __('Yes') }}</option>
                                        </select>
                                    </div>
                                </div>
