...
@section('content')
    <div class="col-12 p-3">
        ...
        <div class="col-12 col-lg-12 p-0 ">
            <div class="container  mt-6 mb-7" id="prescription">
                        ...
                        <div class="card">
                            <div class="card-body p-5">
                                ...
                                <div class="border-top border-gray-200 pt-4 mt-4">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="text-muted mb-2">{{ __('Prescription No.') }}</div>
                                            <strong>#{{ $prescription->id}}</strong>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <div class="text-muted mb-2">{{ __('Prescription Date') }}</div>
                                            <strong>{{ $prescription->created_at->toDateString()}}</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="border-top border-gray-200 mt-4 py-4">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <strong> {{ $prescription->appointment->patient->name}} </strong>
                                        </div>
                                    </div>
                                </div>
                                <table class="table border-bottom border-gray-200">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="px-0"><p>{{ $prescription->prescription }}</p></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="mt-5">
                                    <div class="d-flex justify-content-start">
                                        <p class="text-muted me-3">{{ __('Signature')}} :</p>
                                        <span></span>
                                    </div>
