...
<div class="p-3">
	...
	<x-bread-crumb :breads="[
			...
			['url' => route('admin.clinic.appointments.index') , 'title' => __('Appointments') , 'isactive' => true],
		]">
		</x-bread-crumb>
	<!-- /breadcrumb -->
	...
	<div class="col-12 pt-3 main-box">
		...
		<div class="row p-3">
			<div class="col-lg-6">
				<span class="fas fa-calendar-check"></span>	{{ __('Appointments') }}
			</div>
		...
		<div class="row">
								...
								<tr>
									...
									<td>
										...
										<form method="POST" action="{{route('admin.clinic.appointments.destroy',$appointment)}}" class="d-inline-block">
											@csrf 
											@method("DELETE")
											<input type="hidden" name="redirect" value="{{ route('admin.clinic.appointments.index')}}">
			...
			<div class="col-lg-12 p-3">
				{{$appointments->appends(request()->query())->render()}}
			</div>
		</div>
